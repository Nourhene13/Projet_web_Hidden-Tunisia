...
class BlogArticleController extends AbstractController
{
    ...
    #[Route('/blog_article_back', name: 'app_blog_article_back')]
    public function blogArticleBack(Request $request): Response
    {
        $data = $this->getDoctrine()->getRepository(BlogArticle::class)->findAll();
        return $this->render('blog_article/afficherback.html.twig', [
            'list' => $data,
        ]);
    }
    ...
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $blogArticle->setUtilisateur($this->getUser());
